        ...
        <div class="top-part">
            <div class="info">
                <p>
                    ...
                    facilisis ament vulpante.
                </p>
                <h1>
                    FOOD IS OUR COMMON <br /> GROUND, A UNIVERSAL <br /> EXPERIENCE
                </h1>
                <p>
                    Tristique tempus condimentum diam donec. Condimentum <br />
                    ullamcorper sit elementum hendrerit mi nulla in consequat, ut. <br />
